          ...
          <div class="row">
            <div class="col-md-3 col-sm-6 col-12">
              <div class="info-box">
                ...
                <?php
                $query = mysqli_query($conn, "SELECT SUM(gfwithdraw) AS total_genfund FROM savings");
                if ($query) {
                  $result = mysqli_fetch_assoc($query);
                  $total_genfund = isset($result['total_genfund']) ? $result['total_genfund'] : 0.00;
                } else {
                  $total_genfund = 0.00;
                }
                ?>
                <div class="info-box-content">
                  <span class="info-box-text">Total GenFund</span>
                  <span class="info-box-number"><?php echo number_format($total_genfund, 2); ?></span>
                </div>
              </div>
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <table id="example1" class="table table-striped">
                    ...
                    <tbody>
                      ...
                      $displaywithdrawGenfund = displaywithdrawGenfund($conn);
                      while ($result = mysqli_fetch_array($displaywithdrawGenfund)) {
                        extract($result);
                      ?>
                        <tr>
                ...
                <div class="modal fade" id="modal-withdraw">
                  <div class="modal-dialog" style="max-width: 400px;">
                    <form id="withdrawgenfund">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h4 class="modal-title">Withdraw GenFund</h4>
